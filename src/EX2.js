function EX2({marginADJ}) {
    return (<div style={{ backgroundColor: 'white', marginTop:'-15%', minHeight:'100px' }}>
    ...
    {/* <div style={{ backgroundColor: 'white', padding:'1%', minHeight:'100px' }}></div> */}
      <section style={{marginBottom:'-50px',marginTop:'-50px',marginLeft:'70px'}} className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          <h1  className='font-size-55px  font-black color-black'><span style={{ backgroundColor: 'white', padding:'1%' }}>My Experience</span></h1>
...
<div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
<div className="mx-auto max-w-2xl lg:max-w-4xl">
  <h2 className="font-size-50-26px"><span style={{ backgroundColor: 'white'}} >Finding my Path</span></h2>
  <figure className="mt-10">
    <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
...
<div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
<div className="mx-auto max-w-2xl lg:max-w-4xl">
<h2  className="font-size-50-26px"><span style={{ backgroundColor: 'white'}} >The Transformation</span></h2>
  <figure className="mt-10">
    <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
      <p>
...
<div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
<div className="mx-auto max-w-2xl lg:max-w-4xl">
<h2 className="font-size-50-26px"><span style={{ backgroundColor: 'white'}} >Projects that Made an Impact</span></h2>
  <figure className="mt-10">
...
<div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
<div className="mx-auto max-w-2xl lg:max-w-4xl">
<h2 className="font-size-50-26px"><span style={{ backgroundColor: 'white'}} >Skills that Set Me Apart</span></h2>
  <figure className="mt-10">
    <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
      <p>
