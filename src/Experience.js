...
<h3 className="longday"  style={{ textAlign:'center' }}>
    <span className='exsect3 gooday' style={{ background: 'rgb(2, 2, 31)', color: 'white', padding: '2%', fontWeight: 'bold', textShadow: '0 0 15px black',}}>
    Finding my Path
    </span>
</h3>
